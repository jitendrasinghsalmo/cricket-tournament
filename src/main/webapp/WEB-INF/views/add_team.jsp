...
<body>
    ...
    <div class="container">
        ...
        <div class="section-header">
            <h1>Add New Cricket Team</h1>
        </div>

        <div class="form-card">
            <form action="/admin/addTeam" method="post" id="addTeamForm">
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="coachName" placeholder="Enter coach name">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="logoUrl" placeholder="Enter logo image URL">
                    </div>

                </div>

                <div class="form-actions">
                    <button type="button" class="btn-clear" onclick="return clearForm(document.getElementById('addTeamForm'));"><i class="fa-solid fa-eraser"></i> Clear</button>
                    <button type="submit" class="btn-submit"><i class="fa-solid fa-check"></i> Save Team</button>
                </div>
            </form>
        </div>

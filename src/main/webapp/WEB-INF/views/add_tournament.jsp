...
<head>
    ...
    <style>
        ...
        /* Calendar icon styling for dark mode compatibility */
    ...
    <div class="container">
        <div class="form-card">
            <div class="form-header">
                ...
                <p>Register a new competitive cricket tournament and scheduling setup</p>
            </div>
            
            <form id="addTournamentForm" action="/admin/addTournament" method="post">
                <div class="form-group">
                    <label>Tournament Name</label>
                    <input type="text" name="tournamentName" class="form-control" placeholder="Enter tournament name..." required>
                </div>

                <div class="form-group">
                    <label>Season</label>
                    <input type="text" name="season" class="form-control" placeholder="e.g. 2026 / Season 1">
                </div>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn-submit"><i class="fa-solid fa-plus"></i> Save Tournament</button>
                </div>
            </form>
        </div>
    </div>

...
<head>
    ...
    <title>ProMatch Arena | Add New User</title>
...
<body>
    ...
    <div class="form-container">
        <div class="form-header">
            <h2 class="jumping-title">Add New <span>User</span></h2>
        </div>
        ...
        <form id="addUserForm" action="/admin/addUser" method="post">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="password" id="passwordField" name="password" required placeholder="Enter secure password">
            ...
            <div class="button-group">
                ...
                <button type="submit" class="btn-submit"><i class="fa-solid fa-user-plus"></i> Save User</button>
            </div>
        </form>
    </div>

    ...
    <div class="form-container">
        ...
        <form action="/updateTournament" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="tournamentName" value="${tournament.tournamentName}" required placeholder="e.g. IPL Championship 2026" autocomplete="off">
            </div>

            <div class="form-group">
                <label>Season</label>
                <input type="text" name="season" value="${tournament.season}" required placeholder="e.g. Season 4" autocomplete="off">
            </div>

...
<head>
    ...
    <title>ProMatch Arena | Add New Player</title>
...
<body>
    ...
    <div class="form-container">
        <div class="form-top-bar">
            <a href="${pageContext.request.contextPath}/viewPlayers/${teamId}" class="btn-back-inline"><i class="fa-solid fa-arrow-left"></i> Back</a>
            <div class="form-title">➕ Add New Player</div>
        </div>

        <form action="${pageContext.request.contextPath}/savePlayer" method="post">
            <input type="hidden" name="teamId" value="${teamId}" />
            
            <div class="form-grid">
                <div class="form-group full-width">
                    <label>Player Full Name</label>
                    <input type="text" name="playerName" placeholder="Enter player name" required autocomplete="off">
                </div>

                <div class="form-group">
                    <label>Age</label>
                    <input type="number" name="age" placeholder="Enter age" min="10" max="60" required>
                </div>

                <div class="form-group">
                    <label>Jersey Number</label>
                    <input type="number" name="jerseyNumber" placeholder="Enter jersey number" min="0" max="999" required>
                </div>

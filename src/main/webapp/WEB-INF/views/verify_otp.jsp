...
<head>
    ...
    <style>
        ...
        .form-control-custom {
            ...
            height: 50px; font-weight: 700; font-size: 1.2rem; padding: 0.5rem 1rem;
        ...
        .form-control-custom::placeholder { color: #94a3b8 !important; opacity: 0.7; letter-spacing: 2px; }
...
<div class="split-auth-container">
    <div class="row g-0">
        ...
        <div class="col-md-5 left-brand-panel">
            <div>
                <a href="${pageContext.request.contextPath}/forgot-password" class="back-arrow-btn" title="Back">
                    <i class="fa-solid fa-arrow-left"></i>
                </a>
            </div>
            <div class="mt-4 mb-3">
                <h3 class="brand-meta-title">Security Key<br><span>Verification.</span></h3>
                <p class="text-white small fw-bold mt-3 opacity-90">Enter the secure 6-digit confirmation token sent to your registered communication channel.</p>
            </div>
        ...
        <div class="col-md-7 right-form-panel">
            <div class="mb-4">
                <h3 class="fw-bold mb-1" style="color: var(--text-heading);">Enter OTP</h3>
                <p class="small fw-bold opacity-70" style="color: var(--text-para);">Verify your 6-digit confirmation code.</p>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/verify-otp" method="post" id="otpForm">
                <div class="mb-4">
                    <label class="form-label-custom" for="otpInput"><i class="fa-solid fa-key"></i> Enter 6-Digit OTP</label>
                    <input type="text" name="otp" class="form-control form-control-custom w-100" id="otpInput" placeholder="------" maxlength="6" required autocomplete="off">
                </div>

                <div>
                    <button type="submit" class="btn btn-submit-success">Verify OTP <i class="fa-solid fa-square-check ms-2"></i></button>
                </div>
            </form>

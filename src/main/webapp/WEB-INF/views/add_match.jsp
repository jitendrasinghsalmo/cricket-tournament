...
<head>
    ...
    <title>ProMatch Arena | Schedule Match</title>
    ...
    <script>
        ...
        function clearForm(formElement) {
            formElement.querySelectorAll('input[type="text"], input[type="datetime-local"]').forEach(input => {
                input.value = '';
            });
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-card">
            <form action="/admin/addMatch" method="post" id="addMatchForm">
                <div class="form-grid">
                ...
                <div class="form-actions">
                    <button type="button" class="btn-clear" onclick="return clearForm(document.getElementById('addMatchForm'));"><i class="fa-solid fa-eraser"></i> Clear</button>
                    <button type="submit" class="btn-submit"><i class="fa-solid fa-check"></i> Save Match</button>
                </div>
            </form>
        </div>
